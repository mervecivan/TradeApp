                ...
                {marketDisplay.map((item, index) => {
                    ...
                    return (
                        <div
                            ...
                            className="flex justify-between items-center p-2 rounded-lg hover:bg-gray-800 transition-colors cursor-pointer"
                        >
                            <div className="flex items-center space-x-3">
                                ...
                                <div>
                                    <p className="text-sm font-medium text-white">{item.symbol ?? "N/A"}</p>
